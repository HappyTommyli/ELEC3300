...
//		  HAL_Delay(100);
//		  Update_Pulse((1600-1)*0.1);
//	  }
//	  if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0)==1){
//		  HAL_Delay(100);
//		  Update_Pulse((1600-1)*0.05);
//	  }
//  }
  void Update_Pulse(uint16_t pulse) {
